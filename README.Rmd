...
The `uarizona` R-package is a utility package with consolidated tools and templates for staffs at uarizona University. The package contains three primary themes:
