...
# .uarizona-blue.outline-text[`r rmarkdown::metadata$title`]

<h2 class="uarizona-blue2 outline-text" style="font-size: 30pt!important;">`r rmarkdown::metadata$week`</h2>
...
<div class="column transition uarizona-m-new delay-1s" style="clip-path:url(#swipe__clip-path);">
