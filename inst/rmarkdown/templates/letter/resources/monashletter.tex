...
\includegraphics[height=1.5cm]{uarizona2}
\end{textblock}%
\begin{textblock}{4}(16.2,1)
...
uarizona University, Victoria 3800, Australia.\\[0.15cm]
...
\@ifundefined{opening}{}{%
\renewcommand*{\opening}[1]{\thispagestyle{uarizona}%
   {\@date\par}%
  \vspace{2\parskip}%
