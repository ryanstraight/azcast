...
class: middle center hide-slide-number uarizona-bg-gray80
...
# .uarizona-blue[`r rmarkdown::metadata$title`]

<h1 class="uarizona-blue" style="font-size: 30pt!important;">`r rmarkdown::metadata$week`</h1>
